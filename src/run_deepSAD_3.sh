...
################################3
# removed: --load_model ../log/mnist/model_0_1_16.tar --load_ae_only True\
...
do
	...
	do
		for kappa in 0 1
		do
			CUDA_VISIBLE_DEVICES=3 python main.py mnist mnist_LeNet ../log/mnist/scenario_3/deepSAD/ ../data --ratio_known_outlier 0.05 --ratio_pollution 0.1 \
