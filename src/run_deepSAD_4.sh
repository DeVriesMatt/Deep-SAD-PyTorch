...
do
	...
	do
		...
		do
			...
			CUDA_VISIBLE_DEVICES=1 python main.py fmnist fmnist_LeNet ../log/fmnist/scenario_4/deepSAD/ ../data --ratio_known_outlier 0.05 --ratio_pollution 0.1 \
			--lr 0.0001 --n_epochs 150 --lr_milestone 50 --batch_size 200 --weight_decay 0.5e-6 --pretrain False --ae_lr 0.0001 --ae_n_epochs 150 \
