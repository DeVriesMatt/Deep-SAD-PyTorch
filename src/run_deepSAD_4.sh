...
do
	...
	do
		...
		do
			...
			--lr 0.0001 --n_epochs 150 --lr_milestone 50 --batch_size 50 --weight_decay 0.5e-6 --pretrain True --ae_lr 0.0001 --ae_n_epochs 150 \
			--ae_batch_size 50 --ae_weight_decay 0.5e-3 --normal_class $normal_class --known_outlier_class $unknown_class --eta $eta \
