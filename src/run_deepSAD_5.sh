...
do
	...
	do
	    ...
	    do
			CUDA_VISIBLE_DEVICES=1 python main.py fmnist fmnist_LeNet ../log/fmnist/scenario_5/deepSAD ../data  \
			--load_model ../log/fmnist/scenario_5/deepSAD/model_0_1_$dims.tar \
      --load_ae_only True\
