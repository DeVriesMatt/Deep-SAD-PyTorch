...
for normal_class in 5
do
    for unknown_class in 3 4 5 6 7 8 9
    do
        if [ $normal_class -eq $unknown_class ]; then
              continue
        fi
...
#			python baseline_ocsvm.py fmnist ../log/fmnist/scenario_2/ocsvmHybrid ../data \
#			--ratio_known_outlier 0.05 \
#			--ratio_pollution $gamma_p \
#			--kernel rbf \
#			--normal_class $normal_class \
...
#      --seed 0 \
#			--hybrid True \
#			--load_ae ../log/fmnist/scenario_2/deepSAD/model_0_${unknown_class}_005.tar \
#      --case 2 \
#			--n_jobs_dataloader 8
		done
	done
