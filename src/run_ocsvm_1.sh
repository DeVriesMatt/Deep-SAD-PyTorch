...
do
	...
	do
		...
		for gamma_l in 0 #QUESTION
		do
			# OC-SVM
			CUDA_VISIBLE_DEVICES=1 python baseline_ocsvm.py mnist ../log/mnist/scenario_1/ocsvm_raw ../data \
	...
	# 		# OC-SVM Hybrid
			CUDA_VISIBLE_DEVICES=1 python baseline_ocsvm.py mnist ../log/mnist/scenario_1/ocsvm_hybrid ../data \
			--ratio_known_outlier $gamma_l \
			--ratio_pollution 0.1 \
			--kernel rbf \
			--normal_class $normal_class \
